...
GFXTexHandle GFXOpenGLES20iOSTextureManager::_createTextureObject(U32 height,
        U32 width,
        U32 depth,
        GFXFormat format,
        GFXTextureProfile *profile,
...
bool GFXOpenGLES20iOSTextureManager::_loadTexture(GFXTexHandle &aTexture, void *raw)
{
