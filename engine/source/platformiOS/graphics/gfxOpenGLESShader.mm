...
void GFXOpenGLESShaderConstBuffer::internalSet(GFXShaderConstHandle* handle, const ConstType& param)
{
   AssertFatal(handle, "GFXOpenGLESShaderConstBuffer::internalSet - Handle is NULL!" );
   AssertFatal(handle->isValid(), "GFXOpenGLESShaderConstBuffer::internalSet - Handle is not valid!" );
   AssertFatal(dynamic_cast<GFXOpenGLESShaderConstHandle*>(handle), "GFXOpenGLESShaderConstBuffer::set - Incorrect const buffer type");

   GFXOpenGLESShaderConstHandle* _glHandle = static_cast<GFXOpenGLESShaderConstHandle*>(handle);
   AssertFatal(mShader == _glHandle->mShader, "GFXOpenGLESShaderConstBuffer::set - Should only set handles which are owned by our shader");
   
   dMemcpy(mBuffer + _glHandle->mOffset, &param, sizeof(ConstType));
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const F32 fv)
{
   internalSet(handle, fv);
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const Point2F& fv)
{
   internalSet(handle, fv);
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const Point3F& fv)
{
   internalSet(handle, fv);
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const Point4F& fv)
{
   internalSet(handle, fv);
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const PlaneF& fv)
{
   internalSet(handle, fv);
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const S32 fv)
{
   internalSet(handle, fv);
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const Point2I& fv)
{
   internalSet(handle, fv);
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const Point3I& fv)
{
   internalSet(handle, fv);
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const Point4I& fv)
{
   internalSet(handle, fv);
}

//template<typename ConstType>
//void GFXOpenGLESShaderConstBuffer::internalSet(GFXShaderConstHandle* handle, const AlignedArray<ConstType>& fv)
//{
//   AssertFatal(handle, "GFXOpenGLESShaderConstBuffer::internalSet - Handle is NULL!" );
//   AssertFatal(handle->isValid(), "GFXOpenGLESShaderConstBuffer::internalSet - Handle is not valid!" );
//   AssertFatal(dynamic_cast<GFXOpenGLESShaderConstHandle*>(handle), "GFXOpenGLESShaderConstBuffer::set - Incorrect const buffer type");
...
//}
//
//void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const AlignedArray<F32>& fv)
//{
//   internalSet(handle, fv);
//}
//
//void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const AlignedArray<Point2F>& fv)
//{
//   internalSet(handle, fv);
//}
//
//void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const AlignedArray<Point3F>& fv)
//{
//   internalSet(handle, fv);
//}
//
//void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const AlignedArray<Point4F>& fv)   
//{
//   internalSet(handle, fv);
//}
//
//void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const AlignedArray<S32>& fv)
//{
//   internalSet(handle, fv);
//}
//
//void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const AlignedArray<Point2I>& fv)
//{
//   internalSet(handle, fv);
//}
//
//void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const AlignedArray<Point3I>& fv)
//{
//   internalSet(handle, fv);
//}
//
//void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const AlignedArray<Point4I>& fv)
//{
//   internalSet(handle, fv);
//}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const MatrixF& mat, const GFXShaderConstType matType)
{
   AssertFatal(handle, "GFXOpenGLESShaderConstBuffer::set - Handle is NULL!" );
   AssertFatal(handle->isValid(), "GFXOpenGLESShaderConstBuffer::set - Handle is not valid!" );
   AssertFatal(dynamic_cast<GFXOpenGLESShaderConstHandle*>(handle), "GFXOpenGLESShaderConstBuffer::set - Incorrect const buffer type");
   ...
   case GFXSCT_Float4x4:
      ...
      break;
   default:
      AssertFatal(false, "GFXOpenGLESShaderConstBuffer::set - Invalid matrix type");
      break;
   }
}

void GFXOpenGLESShaderConstBuffer::set(GFXShaderConstHandle* handle, const MatrixF* mat, const U32 arraySize, const GFXShaderConstType matrixType)
{
   AssertFatal(handle, "GFXOpenGLESShaderConstBuffer::set - Handle is NULL!" );
   AssertFatal(handle->isValid(), "GFXOpenGLESShaderConstBuffer::set - Handle is not valid!" );
   ...
   switch (matrixType) {
      case GFXSCT_Float4x4:
         ...
         break;
      default:
         AssertFatal(false, "GFXOpenGLESShaderConstBuffer::set - setting array of non 4x4 matrices!");
         break;
   }
}

void GFXOpenGLESShaderConstBuffer::activate()
{
   mShader->setConstantsFromBuffer(this);
   mWasLost = false;
}

const String GFXOpenGLESShaderConstBuffer::describeSelf() const
{
   return String();
}

void GFXOpenGLESShaderConstBuffer::onShaderReload( GFXOpenGLESShader *shader )
{
   AssertFatal( shader == mShader, "GFXOpenGLESShaderConstBuffer::onShaderReload, mismatched shaders!" );
...
GFXOpenGLESShader::GFXOpenGLESShader() :
   mVertexShader(0),
   mPixelShader(0),
   mProgram(0),
   mConstBufferSize(0),
...
void GFXOpenGLESShader::clearShaders()
{
...
bool GFXOpenGLESShader::_init()
{
   ...
   if(!compiledVertexShader || !compiledPixelShader)
    ...
    glBindAttribLocation(mProgram, ATTRIB_POSITION, "Position");
    glBindAttribLocation(mProgram, ATTRIB_COLOR, "SourceColor");
    glBindAttribLocation(mProgram, ATTRIB_NORMAL, "Normal");
    glBindAttribLocation(mProgram, ATTRIB_TEXCOORD, "inTexCoord");
    glBindAttribLocation(mProgram, ATTRIB_TEXCOORD+1, "inTexCoord2");
    // Link it!
...
void GFXOpenGLESShader::initConstantDescs()
{
   mConstants.clear();
   GLint numUniforms;
   ...
   for(U32 i = 0; i < numUniforms; i++)
   {
      ...
      switch(type)
      {
         ...
         case GL_SAMPLER_CUBE:
            ...
            break;
         default:
            AssertFatal(false, "GFXOpenGLESShader::initConstantDescs - unrecognized uniform type");
...
void GFXOpenGLESShader::initHandles()
{      
   ...
   for ( U32 i = 0; i < mConstants.size(); i++ )
   {
      ...
      else 
      {
         ...
         mHandles[desc.name] = new GFXOpenGLESShaderConstHandle( this, desc, loc, sampler );
      }
   }
   ...
   for ( HandleMap::iterator iter = mHandles.begin(); iter != mHandles.end(); ++iter )
   {
      GFXOpenGLESShaderConstHandle* handle = iter->value;
      if ( handle->isValid() )
      {
...
GFXShaderConstHandle* GFXOpenGLESShader::getShaderConstHandle(const String& name)
{
   ...
   {
      GFXOpenGLESShaderConstHandle* handle = new GFXOpenGLESShaderConstHandle( this );
...
void GFXOpenGLESShader::setConstantsFromBuffer(GFXOpenGLESShaderConstBuffer* buffer)
{
   for(Vector<GFXOpenGLESShaderConstHandle*>::iterator i = mValidHandles.begin(); i != mValidHandles.end(); ++i)
   {
      GFXOpenGLESShaderConstHandle* handle = *i;
      AssertFatal(handle, "GFXOpenGLESShader::setConstantsFromBuffer - Null handle");
...
GFXShaderConstBufferRef GFXOpenGLESShader::allocConstBuffer()
{
   GFXOpenGLESShaderConstBuffer* buffer = new GFXOpenGLESShaderConstBuffer(this, mConstBufferSize, mConstBuffer);
   buffer->registerResourceWithDevice(getOwningDevice());
   mActiveBuffers.push_back( buffer );
   return buffer;
}

void GFXOpenGLESShader::useProgram()
{
   glUseProgram(mProgram);
}

void GFXOpenGLESShader::zombify()
{
   clearShaders();
   dMemset(mConstBuffer, 0, mConstBufferSize);
}

char* GFXOpenGLESShader::_handleIncludes( const StringTableEntry path, FileStream *s )
{
...
//         StringTableEntry includePath = StringTableEntry::Join(path.getPath(), '/', includeFile);
//         includePath = StringTableEntry::CompressPath(includePath);
//         
...
//            if ( !includeStream.open( includePath.getFullFileName(), FileStream::Read ) )
//            {
//               AssertISV(false, avar("failed to open include '%s'.", includePath));
//
//               if ( smLogErrors )
//                  Con::errorf( "GFXOpenGLESShader::_handleIncludes - Failed to open include '%s'.", 
//                     includePath );
//
...
//    Con::expandScriptFilename( szFullPathBuffer, sizeof(szFullPathBuffer), file.getFullPath() );
   
   // Ok it's not in the shader gen manager, so ask Torque for it
   FileStream stream;
   if ( !stream.open( file, FileStream::Read ) )
   {
      AssertISV(false, avar("GFXOpenGLESShader::initShader - failed to open shader '%s'.", file));

      if ( smLogErrors )
         Con::errorf( "GFXOpenGLESShader::initShader - Failed to open shader file '%s'.", 
            file );
   ...
   if ( logLength )
   {
      ...
      if ( compileStatus == GL_FALSE )
      {
         if ( smLogErrors )
         {
            Con::errorf( "GFXOpenGLESShader::initShader - Error compiling shader!" );
...
const Vector<GFXShaderConstDesc>& GFXOpenGLESShader::getShaderConstDesc() const
{
   return mConstants;
}

/// Returns the alignment value for constType
U32 GFXOpenGLESShader::getAlignmentValue(const GFXShaderConstType constType) const
{
   // Alignment is the same thing as size for us.
   return shaderConstTypeSize(constType);
}

const String GFXOpenGLESShader::describeSelf() const
{
   String ret;
