...
// Constructor
//-----------------------------------------------------------------------------
GFXOpenGLES30iOSTextureManager::GFXOpenGLES30iOSTextureManager()
{
}
...
GFXTextureObject *GFXOpenGLES30iOSTextureManager::createTexture( GBitmap *bmp, const String &resourceName, GFXTextureProfile *profile, bool deleteBmp )
{
...
GFXTextureObject *GFXOpenGLES30iOSTextureManager::_createTexture(  GBitmap *bmp,
                                                    const String &resourceName,
                                                    GFXTextureProfile *profile,
                                                    bool deleteBmp,
                                                    GFXTextureObject *inObj )
{
    PROFILE_SCOPE( GFXOpenGLES30iOSTextureManager_CreateTexture_Bitmap );
   ...
   GFXOpenGLES30iOSTextureObject* retTex = dynamic_cast<GFXOpenGLES30iOSTextureObject*>(ret);
...
//// createTexture
////-----------------------------------------------------------------------------
GFXTextureObject *GFXOpenGLES30iOSTextureManager::createTexture( const String &fullPath, GFXTextureProfile *profile )
{
    ...
    {
        S32 len = S32(ptr - fullPath.c_str());
    ...
    retTexObj = new GFXOpenGLES30iOSTextureObject( GFX, profile, texture );
...
GFXTextureObject *GFXOpenGLES30iOSTextureManager::_createTextureObject(   U32 height,
                                                               U32 width,
                                                               U32 depth,
                                                               GFXFormat format, 
                                                               GFXTextureProfile *profile, 
                                                               ...
                                                               void* data)
{
   ...
   GFXOpenGLES30iOSTextureObject *retTex;
   if ( inTex )
   {
      AssertFatal( dynamic_cast<GFXOpenGLES30iOSTextureObject*>( inTex ), "GFXOpenGLES30iOSTextureManager::_createTexture() - Bad inTex type!" );
      retTex = static_cast<GFXOpenGLES30iOSTextureObject*>( inTex );
      retTex->release();
   }      
   else
   {
      retTex = new GFXOpenGLES30iOSTextureObject( GFX, profile );
...
static void _slowTextureLoad(GFXOpenGLES30iOSTextureObject* texture, GBitmap* pDL)
{
...
bool GFXOpenGLES30iOSTextureManager::_loadTexture(GFXTextureObject *aTexture, GBitmap *pDL)
{
   GFXOpenGLDevice *device = dynamic_cast<GFXOpenGLDevice*>(GFX);
   GFXOpenGLES30iOSTextureObject *texture = static_cast<GFXOpenGLES30iOSTextureObject*>(aTexture);
   
   AssertFatal(texture->getBinding() == GL_TEXTURE_2D, 
      "GFXOpenGLES30iOSTextureManager::_loadTexture(GBitmap) - This method can only be used with 2D textures");
...
bool GFXOpenGLES30iOSTextureManager::_loadTexture(GFXTextureObject *aTexture, void *raw)
{
...
bool GFXOpenGLES30iOSTextureManager::_freeTexture(GFXTextureObject *texture, bool zombify /*= false*/)
{
   if(zombify)
      static_cast<GFXOpenGLES30iOSTextureObject*>(texture)->zombify();
   else
      static_cast<GFXOpenGLES30iOSTextureObject*>(texture)->release();
      
   return true;
}

bool GFXOpenGLES30iOSTextureManager::_refreshTexture(GFXTextureObject *texture)
{
    GFXOpenGLES30iOSTextureObject * pTextureObject = dynamic_cast<GFXOpenGLES30iOSTextureObject*>(texture);
