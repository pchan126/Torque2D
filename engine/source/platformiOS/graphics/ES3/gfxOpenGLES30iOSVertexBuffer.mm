...
void GFXOpenGLES30iOSVertexBuffer::lock( dsize_t vertexStart, dsize_t vertexEnd, void **vertexPtr )
{
...
void GFXOpenGLES30iOSVertexBuffer::set( void* data, dsize_t dataSize, dsize_t indexCount, void* indexData)
{
