...
void GFXOpenGLES20iOSTextureObject::bind(U32 textureUnit) const
{
//    AssertFatal(mBinding == GL_TEXTURE_2D, "GFXOpenGLES20iOSTextureObject::bind - only GL_TEXTURE_2D supported");
