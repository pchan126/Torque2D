...
{
private:
   typedef VectorPtr<Win32Window*> WindowList;
...
public:
   ...
   Win32Window      *getWindowByGLFW(GLFWwindow* window);
   ...
   static Win32WindowManager* get() { return (Win32WindowManager*)PlatformWindowManager::get(); }
   void _addWindow(Win32Window* window);
   void _removeWindow(Win32Window* window);
   
   void _onAppSignal(WindowId wnd, S32 event);
   
   bool onShutdown();
   bool canWindowGainFocus(Win32Window* window);
