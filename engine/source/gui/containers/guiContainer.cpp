...
void GuiContainer::initPersistFields()
{
   ...
   addGroup( "Layout" );
      ...
      addProtectedField("docking",  TypeEnum,   Offset(mSizingOptions.mDocking, GuiContainer), &setDockingField, &defaultProtectedGetFn, 1, &gDockingTypes, "" );
      addField("margin",         TypeRectI, Offset(mSizingOptions.mPadding, GuiContainer));
      addField("padding",        TypeRectI, Offset(mSizingOptions.mInternalPadding, GuiContainer));
