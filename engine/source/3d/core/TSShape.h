...
class TSShape
{
    ...
    struct Sequence
    {
        ...
        std::bitset<64> rotationMatters;     ///< Set of nodes
        std::bitset<64> translationMatters;  ///< Set of nodes
        std::bitset<64> scaleMatters;        ///< Set of nodes
        std::bitset<64> visMatters;          ///< Set of objects
        std::bitset<64> frameMatters;        ///< Set of objects
        std::bitset<64> matFrameMatters;     ///< Set of objects
        /// @}
...
{
    quat->x = nodeRotations[seq.baseRotation + rotNum*seq.numKeyframes + keyframeNum].x;
    quat->y = nodeRotations[seq.baseRotation + rotNum*seq.numKeyframes + keyframeNum].y;
    quat->z = nodeRotations[seq.baseRotation + rotNum*seq.numKeyframes + keyframeNum].z;
    quat->w = nodeRotations[seq.baseRotation + rotNum*seq.numKeyframes + keyframeNum].w;
    return *quat;
}
