...
#ifndef _GFXOpenGLES30TextureTarget_H_
#define _GFXOpenGLES30TextureTarget_H_

#include "graphics/OpenGL/gfxOpenGLTextureTarget.h"
#include <memory>

class GFXOpenGLES30TextureObject;
...
class GFXOpenGLES30TextureTarget : public GFXOpenGLTextureTarget
{
public:
    GFXOpenGLES30TextureTarget();
    virtual ~GFXOpenGLES30TextureTarget();
